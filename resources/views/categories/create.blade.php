                            ...
                            <nav class="flex text-sm" aria-label="Breadcrumb">
                                <ol class="inline-flex items-center space-x-1 md:space-x-2 flex-wrap">
                                    ...
                                    <li class="flex items-center">
                                        ...
                                        <a href="{{ route('categories.index') }}" class="text-emerald-200 hover:text-white transition-colors">
                                            Categories
                                        </a>
                                    </li>
                                    <li class="flex items-center">
                                        ...
                                        <span class="text-emerald-100 font-medium">Create Category</span>
                                    </li>
                                </ol>
                            </nav>
                        </div>
                                    ...
                                    <div class="flex flex-col sm:flex-row justify-between items-center pt-8 border-t border-gray-200 dark:border-gray-600 space-y-4 sm:space-y-0">
                                        ...
                                        <div class="flex flex-col sm:flex-row space-y-3 sm:space-y-0 sm:space-x-4 w-full sm:w-auto">
                                            ...
                                            <button type="submit" 
                                                    ...
                                                    :class="(isSubmitting || !categoryName.trim()) ? 'bg-gray-400 dark:bg-gray-600 cursor-not-allowed' : 'bg-gradient-to-r from-emerald-600 to-green-700 hover:from-emerald-700 hover:to-green-800 shadow-lg hover:shadow-xl transform hover:scale-105'"
                    ...
                    <div class="bg-gradient-to-br from-emerald-50 to-green-50 dark:from-emerald-900 dark:to-green-900 rounded-2xl border border-emerald-200 dark:border-emerald-700 p-6">
                        ...
                        <div class="space-y-3 text-sm">
                            <div class="flex items-start space-x-2">
                                ...
                                <p class="text-emerald-800 dark:text-emerald-200">Choose descriptive names that are easy to understand</p>
                            </div>
                            <div class="flex items-start space-x-2">
                                <span class="text-emerald-600 dark:text-emerald-400 mt-0.5">•</span>
                                <p class="text-emerald-800 dark:text-emerald-200">Keep names concise but meaningful</p>
                            </div>
                            <div class="flex items-start space-x-2">
                                <span class="text-emerald-600 dark:text-emerald-400 mt-0.5">•</span>
                                <p class="text-emerald-800 dark:text-emerald-200">Use broad categories that can group multiple transactions</p>
                            </div>
                            <div class="flex items-start space-x-2">
                                <span class="text-emerald-600 dark:text-emerald-400 mt-0.5">•</span>
                                <p class="text-emerald-800 dark:text-emerald-200">Avoid overly specific categories that might not be reused</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white dark:bg-gray-900 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 p-6">
                        ...
                        <div class="space-y-3 text-sm">
                            ...
                            <div class="flex justify-between">
                                ...
                                <span class="font-medium text-gray-900 dark:text-white">Creating Category</span>
                            </div>
                        </div>
                    </div>
