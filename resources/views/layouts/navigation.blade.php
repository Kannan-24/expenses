    ...
    <div class="flex-1 overflow-y-auto">
            ...
            <div class="flex items-center justify-between">
                ...
                <div>
                    ...
                    <button @click='darkMode = !darkMode' type="button"
                        class="inline-flex items-center justify-center w-8 h-8 text-gray-600 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 hover:bg-blue-50 dark:hover:bg-blue-900/50 rounded-lg focus:outline-none"
                        role="button" aria-label="Toggle theme">
                        <!-- Sun icon - shown in dark mode -->
                        <svg xmlns="http://www.w3.org/2000/svg"
                            class="icon icon-tabler icon-tabler-sun w-5 h-5 hidden dark:block" width="24"
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg"
                            class="icon icon-tabler icon-tabler-moon w-5 h-5 block dark:hidden" width="24"
                            height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none"
                            stroke-linecap="round" stroke-linejoin="round">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
        ...
        <nav class="p-4 space-y-2">
            ...
            <a href="{{ route('dashboard') }}"
                ...
                <div
                    class="p-2 rounded-lg {{ request()->routeIs('dashboard') ? 'bg-blue-200 dark:bg-blue-800' : 'bg-gray-100 dark:bg-gray-700 group-hover:bg-blue-100 dark:group-hover:bg-blue-900/50' }} ">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="pt-4">
                ...
                @can('manage transactions')
                    <a href="{{ route('transactions.index') }}"
                        ...
                        <div
                            class="p-2 rounded-lg {{ request()->routeIs('transactions.*') ? 'bg-blue-200 dark:bg-blue-800' : 'bg-gray-100 dark:bg-gray-700 group-hover:bg-blue-100 dark:group-hover:bg-blue-900/50' }} ">
                ...
                @can('manage categories')
                    <a href="{{ route('categories.index') }}"
                        ...
                        <div
                            class="p-2 rounded-lg {{ request()->routeIs('categories.*') ? 'bg-blue-200 dark:bg-blue-800' : 'bg-gray-100 dark:bg-gray-700 group-hover:bg-blue-100 dark:group-hover:bg-blue-900/50' }} ">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                @can('manage wallets')
                    <a href="{{ route('wallets.index') }}"
                        ...
                        <div
                            class="p-2 rounded-lg {{ request()->routeIs('wallets.*') ? 'bg-blue-200 dark:bg-blue-800' : 'bg-gray-100 dark:bg-gray-700 group-hover:bg-blue-100 dark:group-hover:bg-blue-900/50' }} ">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                @can('manage budgets')
                    <a href="{{ route('budgets.index') }}"
                        ...
                        <div
                            class="p-2 rounded-lg {{ request()->routeIs('budgets.*') ? 'bg-blue-200 dark:bg-blue-800' : 'bg-gray-100 dark:bg-gray-700 group-hover:bg-blue-100 dark:group-hover:bg-blue-900/50' }} ">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                {{-- @can('manage borrows') --}}
                    <a href="{{ route('borrows.index') }}"
                        class="flex items-center px-4 py-3 rounded-xl  group {{ request()->routeIs('borrows.*') ? 'bg-blue-100 dark:bg-blue-900/50 text-blue-700 dark:text-blue-300 shadow-md' : 'text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 hover:text-blue-600 dark:hover:text-blue-400' }}">
                        <div
                            class="p-2 rounded-lg {{ request()->routeIs('borrows.*') ? 'bg-blue-200 dark:bg-blue-800' : 'bg-gray-100 dark:bg-gray-700 group-hover:bg-blue-100 dark:group-hover:bg-blue-900/50' }} ">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <span class="ml-3 font-medium">Borrows</span>
            ...
            <div class="pt-4">
                ...
                @can('manage expense people')
                    <a href="{{ route('expense-people.index') }}"
                        ...
                        <div
                            class="p-2 rounded-lg {{ request()->routeIs('expense-people.*') ? 'bg-blue-200 dark:bg-blue-800' : 'bg-gray-100 dark:bg-gray-700 group-hover:bg-blue-100 dark:group-hover:bg-blue-900/50' }} ">
                            <svg viewBox="0 0 16 16" class="w-5 h-5" xmlns="http://www.w3.org/2000/svg"
                ...
                @can('generate reports')
                    <a href="{{ route('reports.index') }}"
                        ...
                        <div
                            class="p-2 rounded-lg {{ request()->routeIs('reports.*') ? 'bg-blue-200 dark:bg-blue-800' : 'bg-gray-100 dark:bg-gray-700 group-hover:bg-blue-100 dark:group-hover:bg-blue-900/50' }} ">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <div class="pt-4">
                    ...
                    @can('manage currencies')
                        <a href="{{ route('currencies.index') }}"
                            ...
                            <div
                                class="p-2 rounded-lg {{ request()->routeIs('currencies.*') ? 'bg-blue-200 dark:bg-blue-800' : 'bg-gray-100 dark:bg-gray-700 group-hover:bg-blue-100 dark:group-hover:bg-blue-900/50' }} ">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    @can('manage wallet types')
                        <a href="{{ route('wallet-types.index') }}"
                            ...
                            <div
                                class="p-2 rounded-lg {{ request()->routeIs('wallet-types.*') ? 'bg-blue-200 dark:bg-blue-800' : 'bg-gray-100 dark:bg-gray-700 group-hover:bg-blue-100 dark:group-hover:bg-blue-900/50' }} ">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10">
                                    </path>
                    ...
                    @can('manage users')
                        <a href="{{ route('user.index') }}"
                            ...
                            <div
                                class="p-2 rounded-lg {{ request()->routeIs('users.*') ? 'bg-blue-200 dark:bg-blue-800' : 'bg-gray-100 dark:bg-gray-700 group-hover:bg-blue-100 dark:group-hover:bg-blue-900/50' }} ">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    @can('manage roles')
                        <a href="{{ route('roles.index') }}"
                            ...
                            <div
                                class="p-2 rounded-lg {{ request()->routeIs('roles.*') ? 'bg-blue-200 dark:bg-blue-800' : 'bg-gray-100 dark:bg-gray-700 group-hover:bg-blue-100 dark:group-hover:bg-blue-900/50' }} ">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <div class="pt-4">
                ...
                <a href="{{ route('support_tickets.index') }}"
                    ...
                    <div
                        class="p-2 rounded-lg {{ request()->routeIs('support_tickets.*') ? 'bg-blue-200 dark:bg-blue-800' : 'bg-gray-100 dark:bg-gray-700 group-hover:bg-blue-100 dark:group-hover:bg-blue-900/50' }} ">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
