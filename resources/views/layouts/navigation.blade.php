            ...
            <div class="flex items-center space-x-1">
                ...
                <button @click='darkMode = !darkMode' type="button"
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg"
                        class="icon icon-tabler icon-tabler-sun w-5 h-5 hidden dark:block transition-transform group-hover:rotate-12" width="24"
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg"
                        class="icon icon-tabler icon-tabler-moon w-5 h-5 block dark:hidden transition-transform group-hover:-rotate-12" width="24"
                        height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none"
                        stroke-linecap="round" stroke-linejoin="round">
                        <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
    ...
    <nav class="p-4 space-y-2 pb-6">
        ...
        <a href="{{ route('dashboard') }}"
            ...
            @if (request()->routeIs('dashboard'))
                <div class="ml-auto w-1 h-8 bg-blue-600 dark:bg-blue-400 rounded-full opacity-0 animate-slide-in"></div>
            @endif
        </a>

        <!-- Core Features Section -->
        <div class="pt-4">
            <h4 class="section-header px-4 text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-3 flex items-center">
                <span class="flex-1">Core Features</span>
                <div class="h-px bg-gradient-to-r from-gray-300 to-transparent dark:from-gray-600 flex-1 ml-3"></div>
            </h4>
            ...
            @can('manage expense people')
                <a href="{{ route('expense-people.index') }}"
                    ...
                    <div
                        ...
                        <svg viewBox="0 0 16 16" class="w-5 h-5 transition-transform group-hover:scale-110" xmlns="http://www.w3.org/2000/svg"
                            fill="currentColor">
                            <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                            <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                            <g id="SVGRepo_iconCarrier">
