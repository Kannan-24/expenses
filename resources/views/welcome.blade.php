<x-guest-layout>
    ...
    <section id="home" class="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50">
        <!-- Background Elements -->
        <div class="absolute inset-0 overflow-hidden">
            <div class="absolute -top-40 -right-40 w-80 h-80 bg-gradient-to-br from-blue-400 to-purple-500 opacity-10 rounded-full blur-3xl animate-pulse"></div>
            <div class="absolute -bottom-40 -left-40 w-96 h-96 bg-gradient-to-tr from-indigo-400 to-cyan-400 opacity-10 rounded-full blur-3xl animate-pulse" style="animation-delay: 2s;"></div>
            <div class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-64 h-64 bg-gradient-to-bl from-purple-400 to-pink-400 opacity-5 rounded-full blur-3xl animate-pulse" style="animation-delay: 4s;"></div>
        </div>
        ...
        <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
                ...
                <div class="text-center lg:text-left space-y-8">
                    <!-- Badge -->
                    <div class="inline-flex items-center px-4 py-2 bg-white/80 backdrop-blur-sm rounded-full shadow-lg border border-gray-200">
                    ...
                    <div class="space-y-4">
                        ...
                        <p class="text-xl lg:text-2xl text-gray-600 max-w-2xl leading-relaxed">
                            ...
                            <span class="font-semibold text-blue-600">Start your journey to financial freedom today.</span>
                        </p>
                    </div>
                    ...
                    <div class="flex items-center justify-center lg:justify-start space-x-6 pt-4">
                        <div class="flex -space-x-2">
                            <div class="w-10 h-10 bg-gradient-to-br from-blue-400 to-purple-600 rounded-full border-2 border-white flex items-center justify-center">
                ...
                <div class="relative flex justify-center lg:justify-end">
                    <div class="relative">
                        <!-- Floating Elements -->
                        <div class="absolute -top-6 -left-6 w-24 h-24 bg-gradient-to-br from-green-400 to-emerald-500 rounded-2xl flex items-center justify-center shadow-xl animate-bounce">
                            <svg class="w-12 h-12 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                            </svg>
                        </div>
                        <div class="absolute -top-4 -right-4 w-20 h-20 bg-gradient-to-br from-blue-400 to-blue-600 rounded-2xl flex items-center justify-center shadow-xl animate-bounce" style="animation-delay: 0.5s;">
                            <svg class="w-10 h-10 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"></path>
                            </svg>
                        </div>
                        <div class="absolute -bottom-4 -left-8 w-16 h-16 bg-gradient-to-br from-purple-400 to-purple-600 rounded-2xl flex items-center justify-center shadow-xl animate-bounce" style="animation-delay: 1s;">
                        ...
                        <div class="relative z-10 p-8">
                            <img src="{{ asset('assets/svg/landing.svg') }}" 
                                 alt="Financial Management Dashboard Illustration"
        ...
        <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="text-center mb-16 lg:mb-20">
                ...
                <h2 class="text-4xl lg:text-6xl font-bold text-gray-900 mb-6">
                    Why Choose <span class="bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">Duo Dev Expenses</span>
                </h2>
                <p class="text-xl text-gray-600 max-w-3xl mx-auto">
                    Comprehensive financial management tools designed to help you take control of your money and build lasting wealth.
                </p>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-12">
                @php
                    $features = [
                        [
                            ...
                            'desc' => 'Effortlessly track every transaction with intelligent categorization and automated insights for better financial decisions.',
                        ...
                        [
                            ...
                            'desc' => 'Transform your financial data into beautiful, interactive charts and reports that reveal spending patterns and opportunities.',
                            'highlight' => 'Real-time'
                        ],
                        [
                            'icon' => 'wallet.svg',
                            ...
                            'desc' => 'Seamlessly manage cash, bank accounts, and digital wallets like GPay, Paytm, and PhonePe in one unified dashboard.',
                        ...
                        [
                            ...
                            'desc' => 'Set up recurring transactions, automated bill reminders, and intelligent budget alerts to never miss a payment.',
                            'highlight' => 'Automated'
                        ],
                        [
                            'icon' => 'receipt.svg',
                            ...
                            'desc' => 'Organize and store all your receipts, bills, and invoices digitally with powerful search and categorization.',
                            'highlight' => 'Paperless'
                        ],
                        [
                            'icon' => 'alert.svg',
                            ...
                            'desc' => 'Get personalized notifications for budget limits, bill due dates, and savings opportunities to stay on track.',
                            'highlight' => 'Smart'
                        ],
                    ];
                @endphp
                ...
                @foreach ($features as $index => $feature)
                    <div class="group relative">
                        <!-- Feature Card -->
                        <div class="relative bg-white rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-500 p-8 h-full border border-gray-100 hover:border-blue-200 transform hover:-translate-y-2">
                            <!-- Highlight Badge -->
                            <div class="absolute -top-3 right-6">
                                <span class="bg-gradient-to-r {{ $feature['gradient'] }} text-white px-3 py-1 rounded-full text-xs font-bold shadow-lg">
                                    {{ $feature['highlight'] }}
                                </span>
                            </div>
                            ...
                            <div class="relative mb-6">
                                <div class="w-16 h-16 bg-gradient-to-br {{ $feature['gradient'] }} rounded-2xl flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-300">
                                    <img src="{{ asset('assets/svg/' . $feature['icon']) }}" 
                                         alt="{{ $feature['title'] }}" 
                                         class="w-8 h-8 filter brightness-0 invert">
                                </div>
                                <!-- Glow Effect -->
                                <div class="absolute inset-0 w-16 h-16 bg-gradient-to-br {{ $feature['gradient'] }} rounded-2xl opacity-20 blur-lg group-hover:opacity-40 transition-opacity duration-300"></div>
                            </div>
                            ...
                            <div class="mt-6 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                                <a href="#" class="inline-flex items-center text-sm font-semibold text-blue-600 hover:text-blue-800">
                                    Learn more
    ...
    <section id="how-it-works" class="relative py-20 lg:py-32 bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <!-- Section Header -->
            <div class="text-center mb-16 lg:mb-20">
                <div class="inline-flex items-center px-4 py-2 bg-indigo-100 text-indigo-800 rounded-full text-sm font-semibold mb-6">
                    <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <h2 class="text-4xl lg:text-6xl font-bold text-gray-900 mb-6">
                    Get Started in <span class="bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent">4 Simple Steps</span>
                </h2>
                <p class="text-xl text-gray-600 max-w-3xl mx-auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-6">
                @php
                    $steps = [
                        [
                            ...
                            'step' => '01',
                            'title' => 'Quick Setup',
                            'desc' => 'Create your account and configure your wallets (cash, bank, digital) in under 2 minutes.',
                            'time' => '2 min'
                        ],
                        [
                        ...
                        [
                            ...
                            'step' => '03',
                            'title' => 'Get Insights',
                            'desc' => 'View beautiful analytics, spending patterns, and personalized financial recommendations.',
                            'time' => 'Real-time'
                        ],
                        [
                            'icon' => 'alert-step.svg',
                            ...
                            'step' => '04',
                            'title' => 'Stay on Track',
                            'desc' => 'Set smart budgets, receive alerts, and achieve your financial goals with AI assistance.',
                            'time' => 'Ongoing'
                        ],
                    ];
                @endphp
                ...
                @foreach ($steps as $index => $step)
                    <div class="relative group">
                        ...
                        @if($index < 3)
                            <div class="hidden lg:block absolute top-20 left-full w-full h-0.5 bg-gradient-to-r from-gray-300 to-transparent z-0"></div>
                        @endif

                        <!-- Step Card -->
                        <div class="relative bg-white rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-500 p-8 text-center group-hover:-translate-y-2 border border-gray-100 hover:border-indigo-200">
                            <!-- Step Number -->
                            <div class="absolute -top-4 left-1/2 transform -translate-x-1/2">
                                <div class="w-8 h-8 bg-gradient-to-r {{ $step['gradient'] }} rounded-full flex items-center justify-center text-white font-bold text-sm shadow-lg">
                                    {{ $step['step'] }}
                                </div>
                            </div>
                            ...
                            <div class="relative mb-6 mt-4">
                                <div class="w-20 h-20 bg-gradient-to-br {{ $step['gradient'] }} rounded-2xl flex items-center justify-center mx-auto shadow-xl group-hover:scale-110 transition-transform duration-300">
                                    <img src="{{ asset('assets/svg/' . $step['icon']) }}" 
                                         alt="{{ $step['title'] }}" 
                                         class="w-10 h-10 filter brightness-0 invert">
                                </div>
                                <!-- Glow Effect -->
                                <div class="absolute inset-0 w-20 h-20 bg-gradient-to-br {{ $step['gradient'] }} rounded-2xl opacity-20 blur-lg mx-auto group-hover:opacity-40 transition-opacity duration-300"></div>
                            </div>
        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="text-center mb-16">
                ...
                <h2 class="text-4xl lg:text-5xl font-bold text-gray-900 mb-6">
                    Got <span class="bg-gradient-to-r from-purple-600 to-pink-600 bg-clip-text text-transparent">Questions?</span>
                </h2>
                <p class="text-xl text-gray-600">
                    Everything you need to know about Duo Dev Expenses and getting started with better financial management.
                </p>
            </div>
            ...
            <div class="space-y-4" x-data="{ open: null }">
                @foreach ($faqs as $i => $faq)
                    <div class="bg-gray-50 rounded-2xl border border-gray-200 hover:border-purple-200 transition-colors overflow-hidden">
            ...
            <div class="mt-16 text-center">
                <div class="bg-gradient-to-br from-purple-600 to-indigo-700 rounded-3xl shadow-2xl p-8 lg:p-12 text-white">
                    <h3 class="text-3xl lg:text-4xl font-bold mb-4">Ready to Take Control of Your Finances?</h3>
                    <p class="text-xl mb-8 text-purple-100">Join thousands of users who've transformed their financial habits with Duo Dev Expenses.</p>
