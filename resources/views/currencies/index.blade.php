<x-app-layout>
    <x-slot name="title">
        {{ __('Currencies') }} - {{ config('app.name', 'Cazhoo') }}
    </x-slot>

    <div class="bg-white p-4 rounded-2xl shadow flex flex-col justify-between"
        style="height: 93.5vh; overflow: auto;">
            ...
            <nav class="flex text-sm text-gray-500" aria-label="Breadcrumb">
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                    ...
                    <li class="flex items-center">
                        ...
                        <span class="text-gray-700">Currencies</span>
                    </li>
                </ol>
            </nav>
        ...
        <form method="GET"
            ...
            @if (request('search'))
                ...
                <a href="{{ route('currencies.index') }}" class="text-gray-400 hover:text-red-500 p-1 transition"
                    title="Clear search">
                        ...
                        <tr class="border-b border-gray-200 hover:bg-gray-50">
                            ...
                            <td class="px-4 py-2 text-center space-x-2">
                                ...
                                <form action="{{ route('currencies.destroy', $currency->id) }}" method="POST"
                                    class="inline-block" onsubmit="return confirm('Delete this currency?')">
                                    @csrf
                                    @method('DELETE')
