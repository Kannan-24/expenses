<div class=" space-y-6">
    ...
    <div
        class="relative overflow-hidden bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-800 dark:from-blue-800 dark:via-blue-900 dark:to-indigo-900 border-b border-blue-500 dark:border-blue-600 rounded-2xl shadow-xl">
        <div class="absolute inset-0 bg-black opacity-10 dark:opacity-30"></div>
        <div
            class="absolute -top-4 -right-4 w-32 h-32 bg-white opacity-10 dark:bg-gray-300 dark:opacity-10 rounded-full">
        </div>
        <div
            class="absolute -bottom-4 -left-4 w-24 h-24 bg-white opacity-10 dark:bg-gray-300 dark:opacity-10 rounded-full">
        </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <!-- Income Card -->
        <div
            class="bg-white dark:bg-gray-900 rounded-2xl shadow-lg hover:shadow-xl transition-all  overflow-hidden group">
            <div class="p-6">
                <div class="flex items-center justify-between mb-4">
                    <div class="flex items-center space-x-3">
                        <div
                            class="p-3 bg-green-100 dark:bg-green-900 rounded-xl group-hover:bg-green-200 dark:group-hover:bg-green-800 ">
                    ...
                    <div class="text-right">
                        <div
                            ...
                            @if ($insights['income_change'] >= 0)
                                <svg class="w-4 h-4 mr-1 text-green-600 dark:text-green-400" fill="none"
        ...
        <div
            ...
            <div class="p-6">
                <div class="flex items-center justify-between mb-4">
                    <div class="flex items-center space-x-3">
                        <div
                            class="p-3 bg-red-100 dark:bg-red-900 rounded-xl group-hover:bg-red-200 dark:group-hover:bg-red-800 ">
                    ...
                    <div class="text-right">
                        <div
                            ...
                            @if ($insights['expense_change'] >= 0)
                                <svg class="w-4 h-4 mr-1 text-red-600 dark:text-red-400" fill="none"
                                    stroke="currentColor" viewBox="0 0 24 24">
                                    <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                                    <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                                    <g id="SVGRepo_iconCarrier">
        ...
        <div
            ...
            <div class="p-6">
                <div class="flex items-center justify-between mb-4">
                    <div class="flex items-center space-x-3">
                        <div
                            class="p-3 bg-blue-100 dark:bg-blue-900 rounded-xl group-hover:bg-blue-200 dark:group-hover:bg-blue-800 ">
                ...
                <div class="flex items-end justify-between">
                    <div>
                        <p
                            class="text-3xl font-bold {{ $monthlyNetBalance >= 0 ? 'text-blue-600 dark:text-blue-400' : 'text-red-600 dark:text-red-400' }}">
            ...
            <div
                class="h-2 bg-gradient-to-r {{ $monthlyNetBalance >= 0 ? 'from-blue-400 to-blue-600 dark:from-blue-600 dark:to-blue-800' : 'from-red-400 to-red-600 dark:from-red-600 dark:to-red-800' }}">
            </div>
        </div>
    </div>
                    ...
                    <table class="min-w-full">
                        <thead>
                            <tr class="border-b border-gray-100 dark:border-gray-800">
                                <th class="text-left py-3 px-4 font-semibold text-gray-700 dark:text-gray-300 text-sm">
                                    #</th>
                                <th class="text-left py-3 px-4 font-semibold text-gray-700 dark:text-gray-300 text-sm">
                                    Date</th>
                                <th class="text-left py-3 px-4 font-semibold text-gray-700 dark:text-gray-300 text-sm">
                                ...
                                <th class="text-left py-3 px-4 font-semibold text-gray-700 dark:text-gray-300 text-sm">
                                    Method</th>
                                <th
                                    class="text-right py-3 px-4 font-semibold text-gray-700 dark:text-gray-300 text-sm">
                                    Amount</th>
                            </tr>
                        </thead>
                                ...
                                <tr class="hover:bg-gray-50 dark:hover:bg-gray-800">
                                    ...
                                    <td class="py-4 px-4">
                                        <div class="flex items-center">
                                            @if ($expense->wallet)
                                                <div class="w-2 h-2 bg-blue-400 dark:bg-blue-600 rounded-full mr-2">
                                                </div>
                                                <span
                                                    class="text-sm text-gray-600 dark:text-gray-400">{{ $expense->wallet->name }}</span>
                                            @endif
                                        </div>
                                    </td>
                                    <td class="py-4 px-4 text-right">
                                        <span
                                            class="text-sm font-semibold {{ $expense->type === 'income' ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400' }}">
                                ...
                                <tr>
                                    <td colspan="5" class="text-center py-12">
                                        <div class="flex flex-col items-center">
                                            <svg class="w-12 h-12 text-gray-400 dark:text-gray-700 mb-4"
                                                fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                    d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z">
                                                </path>
                                            </svg>
                                            <p class="text-gray-500 dark:text-gray-400 font-medium">No recent
                                                transactions</p>
                                            <p class="text-gray-400 dark:text-gray-600 text-sm">Your transactions will
                                                appear here</p>
                                        </div>
                                    </td>
                                </tr>
                ...
                <table class="min-w-full">
                    <thead>
                        <tr class="border-b border-gray-100 dark:border-gray-800">
                            ...
                            <th class="text-left py-3 px-4 font-semibold text-gray-700 dark:text-gray-300 text-sm">
                                Month</th>
                            <th class="text-right py-3 px-4 font-semibold text-gray-700 dark:text-gray-300 text-sm">
                                Income</th>
                            <th class="text-right py-3 px-4 font-semibold text-gray-700 dark:text-gray-300 text-sm">
                                Expense</th>
                            <th class="text-right py-3 px-4 font-semibold text-gray-700 dark:text-gray-300 text-sm">Net
                            </th>
                        </tr>
                    </thead>
                    <tbody class="divide-y divide-gray-50 dark:divide-gray-800">
                        @forelse ($monthlyData as $month)
                            ...
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-800">
                                ...
                                <td class="py-4 px-4 text-right">
                                    <span
                                        class="text-sm font-bold {{ $netAmount >= 0 ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400' }}">
                        ...
                        @empty
                            <tr>
                                <td colspan="5" class="text-center py-12">
                                    <div class="flex flex-col items-center">
                                        <svg class="w-12 h-12 text-gray-400 dark:text-gray-700 mb-4" fill="none"
                                            stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z">
                                            </path>
                                        </svg>
                                        <p class="text-gray-500 dark:text-gray-400 font-medium">No monthly data
                                            available</p>
                                        <p class="text-gray-400 dark:text-gray-600 text-sm">Start adding transactions
                                            to see your monthly summary</p>
                                    </div>
                                </td>
                            </tr>
                        @endforelse
