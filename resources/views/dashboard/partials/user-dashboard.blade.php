<div class=" space-y-6">
    ...
    <div class="relative overflow-hidden bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-800 dark:from-blue-900 dark:via-blue-950 dark:to-indigo-950 rounded-2xl shadow-xl">
        ...
        <div class="relative p-8 text-white dark:text-blue-100">
            <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between">
                <div>
                    <h1 class="text-3xl lg:text-4xl font-bold mb-2">
                        Good <span id="greeting"></span>, {{ auth()->user()->name }}!
                    </h1>
                    <p class="text-blue-100 dark:text-blue-200 text-lg mb-4 lg:mb-0">
                        Here's your financial overview for this month
                    </p>
                </div>
                <div class="bg-white bg-opacity-20 dark:bg-gray-800 dark:bg-opacity-50 backdrop-blur-sm rounded-xl p-4">
                    <div class="text-right">
                        <p class="text-sm text-blue-100 dark:text-blue-300">Current Date</p>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <!-- Income Card -->
        <div class="bg-white dark:bg-gray-900 rounded-2xl shadow-lg hover:shadow-xl transition-all  overflow-hidden group">
            <div class="p-6">
                <div class="flex items-center justify-between mb-4">
                    <div class="flex items-center space-x-3">
                        <div class="p-3 bg-green-100 dark:bg-green-900 rounded-xl group-hover:bg-green-200 dark:group-hover:bg-green-800 ">
                            <svg class="w-6 h-6 text-green-600 dark:text-green-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 11l5-5m0 0l5 5m-5-5v12"></path>
                            </svg>
                        </div>
                        <div>
                            <p class="text-sm font-medium text-gray-600 dark:text-gray-400">This Month's</p>
                            <p class="text-lg font-bold text-gray-900 dark:text-white">Income</p>
                        </div>
                    </div>
                </div>
                <div class="flex items-end justify-between">
                    <div>
                        <p class="text-3xl font-bold text-green-600 dark:text-green-400">₹{{ number_format($totalIncome, 2) }}</p>
                        <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">{{ $insights['income_change'] >= 0 ? '+'.$insights['income_change'].'%' : ' '.$insights['income_change'].'%' }} from last month</p>
                    </div>
                    <div class="text-right">
                        <div class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-green-100 dark:bg-green-900 text-green-800 dark:text-green-300">
            ...
            <div class="h-2 bg-gradient-to-r from-green-400 to-green-600 dark:from-green-600 dark:to-green-800"></div>
        </div>
        ...
        <div class="bg-white dark:bg-gray-900 rounded-2xl shadow-lg hover:shadow-xl transition-all  overflow-hidden group">
            <div class="p-6">
                <div class="flex items-center justify-between mb-4">
                    <div class="flex items-center space-x-3">
                        <div class="p-3 bg-red-100 dark:bg-red-900 rounded-xl group-hover:bg-red-200 dark:group-hover:bg-red-800 ">
                        ...
                        <div>
                            <p class="text-sm font-medium text-gray-600 dark:text-gray-400">This Month's</p>
                            <p class="text-lg font-bold text-gray-900 dark:text-white">Expense</p>
                        </div>
                    </div>
                </div>
                <div class="flex items-end justify-between">
                    <div>
                        <p class="text-3xl font-bold text-red-600 dark:text-red-400">₹{{ number_format($totalExpense, 2) }}</p>
                        <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">{{ $insights['expense_change'] >= 0 ? '+'.$insights['expense_change'].'%' : ' '.$insights['expense_change'].'%' }} from last month</p>
                    </div>
                    <div class="text-right">
                        <div class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-red-100 dark:bg-red-900 text-red-800 dark:text-red-300">
            ...
            <div class="h-2 bg-gradient-to-r from-red-400 to-red-600 dark:from-red-600 dark:to-red-800"></div>
        </div>
        ...
        <div class="bg-white dark:bg-gray-900 rounded-2xl shadow-lg hover:shadow-xl transition-all  overflow-hidden group">
            <div class="p-6">
                <div class="flex items-center justify-between mb-4">
                    <div class="flex items-center space-x-3">
                        <div class="p-3 bg-blue-100 dark:bg-blue-900 rounded-xl group-hover:bg-blue-200 dark:group-hover:bg-blue-800 ">
                        ...
                        <div>
                            ...
                            <p class="text-lg font-bold text-gray-900 dark:text-white">Balance</p>
                        </div>
                    </div>
                </div>
                <div class="flex items-end justify-between">
                    <div>
                        <p class="text-3xl font-bold {{ $monthlyNetBalance >= 0 ? 'text-blue-600 dark:text-blue-400' : 'text-red-600 dark:text-red-400' }}">
                            ₹{{ number_format($monthlyNetBalance, 2) }}
                        </p>
                        <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Current month</p>
                    </div>
                    <div class="text-right">
                        <div class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium
                            {{ $monthlyNetBalance >= 0 ? 'bg-blue-100 dark:bg-blue-900 text-blue-800 dark:text-blue-300' : 'bg-red-100 dark:bg-red-900 text-red-800 dark:text-red-300' }}">
                            {{ $monthlyNetBalance >= 0 ? 'Profit' : 'Loss' }}
                        </div>
                    </div>
                </div>
            </div>
            <div class="h-2 bg-gradient-to-r {{ $monthlyNetBalance >= 0 ? 'from-blue-400 to-blue-600 dark:from-blue-600 dark:to-blue-800' : 'from-red-400 to-red-600 dark:from-red-600 dark:to-red-800' }}"></div>
        </div>
    </div>
            ...
            <div class="p-6 border-b border-gray-100 dark:border-gray-800">
                <div class="flex items-center justify-between">
                    <h3 class="text-xl font-bold text-gray-900 dark:text-white flex items-center">
                        <svg class="w-6 h-6 mr-2 text-blue-600 dark:text-blue-400" fill="none" viewBox="0 0 24 24">
                    ...
                    <a href="{{ route('transactions.index') }}" 
                       class="inline-flex items-center px-4 py-2 text-sm font-medium text-blue-600 dark:text-blue-400 bg-blue-50 dark:bg-gray-800 rounded-lg hover:bg-blue-100 dark:hover:bg-blue-900 transition-colors">
                        View All
                    ...
                    <table class="min-w-full">
                        <thead>
                            <tr class="border-b border-gray-100 dark:border-gray-800">
                                <th class="text-left py-3 px-4 font-semibold text-gray-700 dark:text-gray-300 text-sm">#</th>
                                <th class="text-left py-3 px-4 font-semibold text-gray-700 dark:text-gray-300 text-sm">Date</th>
                                <th class="text-left py-3 px-4 font-semibold text-gray-700 dark:text-gray-300 text-sm">Type</th>
                                <th class="text-left py-3 px-4 font-semibold text-gray-700 dark:text-gray-300 text-sm">Method</th>
                                <th class="text-right py-3 px-4 font-semibold text-gray-700 dark:text-gray-300 text-sm">Amount</th>
                            </tr>
                        </thead>
                        <tbody class="divide-y divide-gray-50 dark:divide-gray-800">
                            @forelse ($recentExpenses as $expense)
                                <tr class="hover:bg-gray-50 dark:hover:bg-gray-800">
                                    <td class="py-4 px-4 text-sm font-medium text-gray-900 dark:text-gray-100">{{ $loop->iteration }}</td>
                                    <td class="py-4 px-4 text-sm text-gray-600 dark:text-gray-400">
                                        {{ \Carbon\Carbon::parse($expense->date)->format('M d, Y') }}
                                    </td>
                                    <td class="py-4 px-4">
                                        <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium 
                                            {{ $expense->type === 'income' ? 'bg-green-100 dark:bg-green-900 text-green-800 dark:text-green-300' : 'bg-red-100 dark:bg-red-900 text-red-800 dark:text-red-300' }}">
                                    ...
                                    <td class="py-4 px-4">
                                        <div class="flex items-center">
                                            @if ($expense->wallet)
                                                <div class="w-2 h-2 bg-blue-400 dark:bg-blue-600 rounded-full mr-2"></div>
                                                <span class="text-sm text-gray-600 dark:text-gray-400">{{ $expense->wallet->name }}</span>
                                            @endif
                                        </div>
                                    </td>
                                    <td class="py-4 px-4 text-right">
                                        <span class="text-sm font-semibold {{ $expense->type === 'income' ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400' }}">
                                ...
                                <tr>
                                    <td colspan="5" class="text-center py-12">
                                        <div class="flex flex-col items-center">
                                            <svg class="w-12 h-12 text-gray-400 dark:text-gray-700 mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path>
                                            </svg>
                                            <p class="text-gray-500 dark:text-gray-400 font-medium">No recent transactions</p>
                                            <p class="text-gray-400 dark:text-gray-600 text-sm">Your transactions will appear here</p>
                                        </div>
                                    </td>
                                </tr>
                            @endforelse
            ...
            <div class="p-6 space-y-4">
                @foreach ($wallets as $wallet)
                    <div class="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-800 rounded-xl hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors">
                        <div class="flex items-center space-x-3">
                            <div class="w-10 h-10 bg-gradient-to-br from-purple-400 to-purple-600 dark:from-purple-700 dark:to-purple-900 rounded-lg flex items-center justify-center">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-500 dark:text-gray-400">{{ $wallet->type ?? 'Savings' }}</p>
                            </div>
                        </div>
                        <div class="text-right">
                            <p class="font-bold text-lg text-gray-900 dark:text-white">₹{{ number_format($wallet->balance, 2) }}</p>
                        </div>
                    </div>
                @endforeach
    
                <div class="mt-6 pt-4 border-t border-gray-200 dark:border-gray-800">
                    <div class="flex items-center justify-between p-4 bg-gradient-to-r from-purple-50 to-blue-50 dark:from-purple-900 dark:to-blue-900 rounded-xl">
                        <div class="flex items-center space-x-3">
                            <div class="w-10 h-10 bg-gradient-to-br from-purple-600 to-blue-600 dark:from-purple-700 dark:to-blue-800 rounded-lg flex items-center justify-center">
                                <svg class="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div>
                            <p class="text-2xl font-bold text-gray-900 dark:text-white">₹{{ number_format($wallets->sum('balance'), 2) }}</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="bg-white dark:bg-gray-900 rounded-2xl shadow-lg hover:shadow-xl transition-all ">
        <div class="p-6 border-b border-gray-100 dark:border-gray-800">
            <h3 class="text-xl font-bold text-gray-900 dark:text-white flex items-center">
                <svg class="w-6 h-6 mr-2 text-indigo-600 dark:text-indigo-400" fill="none"  viewBox="0 0 24 24">
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full">
                    <thead>
                        <tr class="border-b border-gray-100 dark:border-gray-800">
                            <th class="text-left py-3 px-4 font-semibold text-gray-700 dark:text-gray-300 text-sm">#</th>
                            <th class="text-left py-3 px-4 font-semibold text-gray-700 dark:text-gray-300 text-sm">Month</th>
                            <th class="text-right py-3 px-4 font-semibold text-gray-700 dark:text-gray-300 text-sm">Income</th>
                            <th class="text-right py-3 px-4 font-semibold text-gray-700 dark:text-gray-300 text-sm">Expense</th>
                            <th class="text-right py-3 px-4 font-semibold text-gray-700 dark:text-gray-300 text-sm">Net</th>
                        </tr>
                    </thead>
                    <tbody class="divide-y divide-gray-50 dark:divide-gray-800">
                        @forelse ($monthlyData as $month)
                            ...
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-800">
                                ...
                                <td class="py-4 px-4 text-right">
                                    <span class="text-sm font-bold {{ $netAmount >= 0 ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400' }}">
                            ...
                            <tr>
                                <td colspan="5" class="text-center py-12">
                                    <div class="flex flex-col items-center">
                                        ...
                                        <p class="text-gray-500 dark:text-gray-400 font-medium">No monthly data available</p>
                                        <p class="text-gray-400 dark:text-gray-600 text-sm">Start adding transactions to see your monthly summary</p>
                                    </div>
                                </td>
                            </tr>
                        @endforelse
            ...
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-4 sm:space-y-0">
                ...
                <div class="flex items-center space-x-2">
                    ...
                    <select id="dateRangeSelector"
                        class="border border-gray-300 dark:border-gray-700 rounded-lg px-3 py-2 text-sm text-gray-700 dark:text-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white dark:bg-gray-800 shadow-sm">
