<x-app-layout>
    ...
    <div class="w-full mx-auto max-w-7xl p-4 lg:p-2 space-y-6">
        ...
        <div class="relative bg-gradient-to-br from-indigo-600 via-purple-700 to-blue-800 rounded-2xl shadow-xl overflow-hidden">
                ...
                <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between">
                    <div class="flex items-center space-x-6">
                        ...
                        <div class="relative">
                            ...
                            @else
                                <div class="w-24 h-24 lg:w-32 lg:h-32 bg-gradient-to-br from-blue-400 to-purple-600 rounded-full flex items-center justify-center ring-4 ring-white ring-opacity-30 shadow-xl">
                        ...
                        <div>
                            ...
                            <p class="text-indigo-200 text-lg">{{ $user->email }}</p>
                            <div class="flex items-center space-x-4 mt-3 text-indigo-100">
                    ...
                    <div class="mt-6 lg:mt-0 flex flex-col sm:flex-row space-y-3 sm:space-y-0 sm:space-x-3">
                        <a href="{{ route('profile.edit') }}"
                           class="inline-flex items-center justify-center px-6 py-3 bg-white text-indigo-700 font-semibold rounded-xl hover:bg-indigo-50 transition-all duration-200 shadow-lg hover:shadow-xl">
            ...
            <div class="bg-white rounded-xl shadow-lg p-6 border-l-4 border-blue-500">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-xs text-gray-500 mt-1">Verified account</p>
                    </div>
            ...
            <div class="bg-white rounded-xl shadow-lg p-6 border-l-4 border-purple-500">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-2xl font-bold text-purple-600">{{ $user->created_at->diffForHumans(null, true) }}</p>
                        <p class="text-xs text-gray-500 mt-1">{{ $user->created_at->format('M d, Y') }}</p>
                    </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="bg-gradient-to-r from-gray-50 to-blue-50 border-b border-gray-200 p-6">
                    <div class="flex items-center space-x-3">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-600 mt-1">Your personal account details and information</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="p-6">
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div class="space-y-1">
                                    <label class="text-sm font-semibold text-gray-700">Account Created</label>
                                    <div class="flex items-center p-3 bg-gray-50 rounded-lg border border-gray-200">
                                        <svg class="w-5 h-5 text-gray-400 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3a1 1 0 011-1h6a1 1 0 011 1v4h4a1 1 0 011 1v12a2 2 0 01-2 2H5a2 2 0 01-2-2V8a1 1 0 011-1h4z"></path>
                                        </svg>
                                        <div>
                                            <span class="text-gray-900 font-medium block">{{ $user->created_at->format('M d, Y') }}</span>
                                ...
                                <div class="space-y-1">
                                    ...
                                    <div class="flex items-center p-3 bg-gray-50 rounded-lg border border-gray-200">
                                        ...
                                        <div>
                                            <span class="text-gray-900 font-medium block">{{ $user->updated_at->format('M d, Y') }}</span>
            ...
            <div class="lg:col-span-1 space-y-6">
                ...
                <div class="bg-white rounded-xl shadow-lg border border-gray-100 p-6">
                    ...
                    <div class="space-y-3">
                        <a href="{{ route('profile.edit') }}" 
                           class="w-full flex items-center p-3 text-gray-700 bg-gray-50 rounded-lg hover:bg-blue-50 hover:text-blue-600 transition-all duration-200 group">
                            <div class="p-2 bg-blue-100 group-hover:bg-blue-200 rounded-lg mr-3 transition-colors">
                        ...
                        <a href="{{ route('account.settings') }}" 
                           class="w-full flex items-center p-3 text-gray-700 bg-gray-50 rounded-lg hover:bg-green-50 hover:text-green-600 transition-all duration-200 group">
                            <div class="p-2 bg-green-100 group-hover:bg-green-200 rounded-lg mr-3 transition-colors">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-500">Security & preferences</p>
                            </div>
                        </a>

                        @if(!$user->phone || !$user->address)
                        <div class="w-full flex items-center p-3 text-amber-700 bg-amber-50 rounded-lg border border-amber-200">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-amber-600">Add missing information</p>
                            </div>
                        </div>
                        @endif
                    </div>
                ...
                <div class="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl border border-blue-200 p-6">
                    ...
                    <div class="space-y-3 text-sm">
                        <div class="flex items-start space-x-2">
                            ...
                            <p class="text-blue-800">Keep your profile information up to date for better security</p>
                        </div>
                        <div class="flex items-start space-x-2">
                            <span class="text-blue-600 mt-0.5">•</span>
                            <p class="text-blue-800">Add a profile photo to personalize your account</p>
                        </div>
                        <div class="flex items-start space-x-2">
                            <span class="text-blue-600 mt-0.5">•</span>
                            <p class="text-blue-800">Review your privacy settings regularly</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-xl shadow-lg border border-gray-100 p-6">
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="flex items-center justify-between p-2 bg-gray-50 rounded-lg">
                            <span class="text-sm font-medium text-gray-700">Password Strong</span>
                            <svg class="w-5 h-5 text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
                            </svg>
                        </div>
                        <div class="flex items-center justify-between p-2 bg-yellow-50 rounded-lg">
                            <span class="text-sm font-medium text-yellow-800">2FA Available</span>
