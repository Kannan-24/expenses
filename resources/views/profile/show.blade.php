<x-app-layout>
    ...
    <div class="w-full mx-auto max-w-7xl p-4 lg:p-2 space-y-6">
        ...
        <div class="relative bg-gradient-to-br from-indigo-600 via-purple-700 to-blue-800 dark:from-indigo-800 dark:via-purple-900 dark:to-blue-900 rounded-2xl shadow-xl overflow-hidden">
