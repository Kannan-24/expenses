<section class="space-y-8">
    <!-- Enhanced Header -->
    <div class="bg-gradient-to-r from-red-50 to-pink-50 rounded-2xl p-6 border-l-4 border-red-500">
        ...
        <div class="p-6">
            ...
            <div class="mt-6 p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
                <div class="flex items-start space-x-3">
                    ...
                    <div>
                        <h5 class="font-semibold text-yellow-800 mb-1">{{ __('Important Notice') }}</h5>
        ...
        <div class="p-6">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                <button type="button" 
                    ...
                    <h4 class="font-semibold text-gray-900 text-center">{{ __('Complete Data') }}</h4>
                    <p class="text-sm text-gray-600 text-center mt-1">{{ __('All transactions, budgets & settings') }}</p>
                </button>
                ...
                <button type="button" 
                    ...
                    <h4 class="font-semibold text-gray-900 text-center">{{ __('Transactions Only') }}</h4>
                    <p class="text-sm text-gray-600 text-center mt-1">{{ __('Expense & income records') }}</p>
                </button>
                ...
                <button type="button" 
                    ...
                    <h4 class="font-semibold text-gray-900 text-center">{{ __('Financial Reports') }}</h4>
                    <p class="text-sm text-gray-600 text-center mt-1">{{ __('Analytics & insights') }}</p>
                </button>
            </div>
        </div>
    </div> --}}
    ...
    <div class="bg-white rounded-2xl border-2 border-red-200 shadow-sm p-6">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-4 sm:space-y-0">
            <div>
                <h3 class="text-lg font-semibold text-red-800 mb-2">{{ __('Permanently Delete Account') }}</h3>
            ...
            <button type="button"
                    ...
                    class="inline-flex items-center px-6 py-3 bg-gradient-to-r from-red-600 to-red-700 text-white font-semibold rounded-xl shadow-lg hover:shadow-xl hover:from-red-700 hover:to-red-800 transform hover:scale-105 transition-all duration-200 focus:outline-none focus:ring-4 focus:ring-red-200">
        ...
        <div class="p-6">
            ...
            <div class="bg-red-50 border border-red-200 rounded-lg p-4 mb-6">
                <div class="flex items-start space-x-3">
                    ...
                    <div>
                        <h3 class="font-semibold text-red-800 mb-2">{{ __('Warning: Permanent Data Loss') }}</h3>
            ...
            <div class="bg-gray-50 rounded-lg p-4 mb-6">
                <h4 class="font-semibold text-gray-900 mb-3">{{ __('Account to be deleted:') }}</h4>
            ...
            <form method="post" action="{{ route('account.destroy') }}" x-data="deleteAccountForm()" @submit="handleSubmit">
                ...
                <div class="mb-6">
                    ...
                    <div class="relative">
                        <input type="password" 
                               ...
                               class="block w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:outline-none focus:border-red-500 focus:ring-4 focus:ring-red-100 transition-all"
                ...
                <div class="mb-6">
                    <label class="flex items-start space-x-3 cursor-pointer">
                        <input type="checkbox" 
                               ...
                               required
                               class="w-5 h-5 text-red-600 bg-gray-100 border-gray-300 rounded focus:ring-red-500 focus:ring-2 mt-0.5">
                ...
                <div class="flex flex-col sm:flex-row justify-end space-y-3 sm:space-y-0 sm:space-x-3">
                    <button type="button"
                            ...
                            class="px-6 py-3 bg-gray-100 text-gray-700 font-semibold rounded-xl hover:bg-gray-200 transition-colors focus:outline-none focus:ring-4 focus:ring-gray-200">
                        {{ __('Cancel') }}
                    </button>

                    <button type="submit"
                            :disabled="!password || !confirmDeletion || loading"
                            class="px-6 py-3 bg-gradient-to-r from-red-600 to-red-700 text-white font-semibold rounded-xl shadow-lg hover:shadow-xl hover:from-red-700 hover:to-red-800 transition-all duration-200 focus:outline-none focus:ring-4 focus:ring-red-200 disabled:opacity-50 disabled:cursor-not-allowed">
