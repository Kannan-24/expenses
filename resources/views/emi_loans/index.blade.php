<x-app-layout>
    ...
    <div class="min-h-screen" x-data="{ showAdvanced: false }">
        <div class="max-w-7xl mx-auto">
            ...
            <div
                class="bg-white dark:bg-gray-900 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 mb-6 p-6">
                <form method="GET" class="space-y-4" id="filter-form">
                    ...
                    <div class="relative max-w-2xl mx-auto">
                        ...
                        @php
                            $hasFilters =
                                request('search') || request('status') || request('loan_type') || request('category');
                        @endphp
                    ...
                    <div class="flex flex-wrap items-center justify-center gap-3">
                        ...
                        <div class="flex flex-wrap gap-2">
                            <button type="button"
                                @click="document.querySelector('select[name=status]').value='active'; document.querySelector('#filter-form').submit();"
                            ...
                            <button type="button"
                                @click="document.querySelector('select[name=status]').value='closed'; document.querySelector('#filter-form').submit();"
                            ...
                            <button type="button"
                                @click="document.querySelector('select[name=loan_type]').value='fixed'; document.querySelector('#filter-form').submit();"
                            ...
                            <button type="button"
                                @click="document.querySelector('select[name=loan_type]').value='reducing_balance'; document.querySelector('#filter-form').submit();"
                        ...
                        <button type="button" @click="showAdvanced = !showAdvanced"
                            ...
                            <svg class="w-4 h-4 mr-2 transition-transform" :class="{ 'rotate-180': showAdvanced }"
                    ...
                    <div x-show="showAdvanced" x-transition
                        class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 pt-4 border-t border-gray-200 dark:border-gray-600">
                        <!-- Status Filter -->
                        <div>
                            <label
                        ...
                        <div>
                            ...
                            <select name="loan_type"
                                ...
                                <option value="fixed" {{ request('loan_type') == 'fixed' ? 'selected' : '' }}>Fixed
                                </option>
                                <option value="reducing_balance"
                                    {{ request('loan_type') == 'reducing_balance' ? 'selected' : '' }}>Reducing Balance
                                </option>
                            </select>
                        </div>
                        ...
                        <div>
                            ...
                            <select name="sort_by"
                                ...
                                <option value="total_amount"
                                    {{ request('sort_by') == 'total_amount' ? 'selected' : '' }}>Total Amount</option>
                                <option value="monthly_emi"
                                    {{ request('sort_by') == 'monthly_emi' ? 'selected' : '' }}>Monthly EMI</option>
                        ...
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-2xl font-bold text-gray-900 dark:text-white">
                                    {{ $emiLoans->where('status', 'active')->count() }}</p>
                            </div>
                    ...
                    <div
                        ...
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-2xl font-bold text-gray-900 dark:text-white">
                                    {{ number_format($emiLoans->sum('total_amount'), 2) }}</p>
                            </div>
                    ...
                    <div
                        ...
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-2xl font-bold text-gray-900 dark:text-white">
                                    {{ number_format($emiLoans->where('status', 'active')->sum('monthly_emi'), 2) }}
                                </p>
                            </div>
                    ...
                    <div
                        ...
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-2xl font-bold text-gray-900 dark:text-white">
                                    {{ $emiLoans->where('status', 'closed')->count() }}</p>
                            </div>
            ...
            <div
                                    ...
                                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors duration-200">
                                        <td class="px-6 py-4">
                                            <div class="flex items-center space-x-3">
                                                <div
                                                    class="flex-shrink-0 w-10 h-10 bg-gradient-to-br from-purple-500 to-indigo-600 rounded-lg flex items-center justify-center">
                                        ...
                                        <td class="px-6 py-4">
                                            ...
                                            @if ($loan->is_auto_deduct)
                                                <div
                                                    class="inline-flex items-center text-xs text-green-600 dark:text-green-400 mt-1">
                                        ...
                                        <td class="px-6 py-4 text-right">
                                            <div class="flex items-center justify-end space-x-2">
                                                ...
                                                <!-- Delete Button -->
                                                <form method="POST" action="{{ route('emi-loans.destroy', $loan) }}"
                                                    class="inline-block">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit"
                ...
                @else
                    ...
                    <div class="text-center py-16">
                        <div
                            class="inline-flex items-center justify-center w-16 h-16 bg-purple-100 dark:bg-purple-900/30 rounded-full mb-4">
                        ...
                        <p class="text-gray-500 dark:text-gray-400 mb-6">Start by creating your first EMI loan to track
            ...
            <div class="mt-6">
                <div class="flex justify-center">
                    @if ($emiLoans->hasPages())
                        <div class="p-6">
                            {{ $emiLoans->links('components.pagination') }}
                        </div>
                    @endif
                </div>
            </div>
