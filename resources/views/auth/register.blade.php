<x-auth-layout>
    ...
    <x-slot name="title">
        {{ __('Register') }} - {{ config('app.name', 'Duo Dev Expenses') }}
    </x-slot>
    ...
    <div class="flex-1 px-16 pt-12 pb-8 flex flex-col justify-center relative">
        <div class="absolute top-6 left-16 right-16 flex justify-between items-center">
            ...
            <div>
                <span class="text-gray-600 text-sm">Already member?</span>
                <a href="{{ route('login') }}" class="text-brand-purple font-medium text-sm ml-1">Sign in</a>
            </div>
        </div>

        <!-- Main Content -->
        <div class="mt-8">
            <h1 class="text-4xl font-bold text-gray-900 mb-3 leading-tight">Sign Up</h1>
            <p class="text-gray-600 text-md mb-6 leading-relaxed">Take control of your spending with Duo Dev Expenses
            </p>
            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="mb-4 flex items-center gap-3">
                    <input type="checkbox" id="termsCheckbox" class="w-4 h-4 ml-2 accent-brand-purple" required>
                    <label for="termsCheckbox" class="text-sm text-gray-600">
                        I agree to the <a href="{{ route('terms') }}" class="text-brand-purple">Terms of Service</a>
                        and <a href="{{ route('privacy') }}" class="text-brand-purple">Privacy Policy</a>
                    </label>
                </div>
    ...
    <div
        ...
        <div class="absolute w-full h-full">
            ...
            <div
                ...
                <div class="text-sm opacity-80 mb-2">Monthly Expenses</div>
                <div class="text-3xl font-bold mb-4">$1,847</div>
                <div class="h-10 bg-white/10 rounded-lg relative overflow-hidden">
                    <div class="absolute bottom-0 left-[10%] w-2 bg-gradient-to-t from-orange-500 to-yellow-400 rounded-sm animate-grow-bar"
                        style="--height: 60%;"></div>
                    <div class="absolute bottom-0 left-[25%] w-2 bg-gradient-to-t from-orange-500 to-yellow-400 rounded-sm animate-grow-bar"
                        style="--height: 80%; animation-delay: 0.2s;"></div>
                    <div class="absolute bottom-0 left-[40%] w-2 bg-gradient-to-t from-orange-500 to-yellow-400 rounded-sm animate-grow-bar"
                        style="--height: 45%; animation-delay: 0.4s;"></div>
                    <div class="absolute bottom-0 left-[55%] w-2 bg-gradient-to-t from-orange-500 to-yellow-400 rounded-sm animate-grow-bar"
                        style="--height: 90%; animation-delay: 0.6s;"></div>
                    <div class="absolute bottom-0 left-[70%] w-2 bg-gradient-to-t from-orange-500 to-yellow-400 rounded-sm animate-grow-bar"
                        style="--height: 65%; animation-delay: 0.8s;"></div>
                </div>
            </div>
            ...
            <div class="absolute bottom-[20%] left-[10%] w-60 bg-white/15 backdrop-blur-xl rounded-3xl p-6 text-white border border-white/20 animate-float-card text-left"
                ...
                <div class="text-lg font-semibold mb-3">Your data, your rules</div>
                <div class="text-sm opacity-80 leading-relaxed">Your financial data belongs to you, and our
                    encryption ensures that only you can access it.</div>
            </div>
