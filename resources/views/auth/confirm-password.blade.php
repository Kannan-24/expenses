<x-app-layout>
    ...
    <div class="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-900 ">
        ...
        <div class="w-full max-w-7xl">
            ...
            <div
                class="bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-800 dark:from-blue-800 dark:via-blue-900 dark:to-indigo-900 border-b border-blue-500 dark:border-blue-600 rounded-t-3xl p-8 text-white relative overflow-hidden">
                <!-- Background Decorations -->
                <div
                    class="absolute top-0 right-0 w-32 h-32 bg-white opacity-10 dark:opacity-20 rounded-full transform translate-x-16 -translate-y-16">
                </div>
                <div
                    class="absolute bottom-0 left-0 w-24 h-24 bg-white opacity-5 dark:opacity-10 rounded-full transform -translate-x-12 translate-y-12">
                </div>

                <div class="relative text-center">
                    <!-- Security Icon -->
                    <div
                        class="inline-flex items-center justify-center w-20 h-20 bg-white bg-opacity-20 dark:bg-white dark:bg-opacity-30 backdrop-blur-sm rounded-full mb-6 border border-white border-opacity-30 dark:border-opacity-50">
                    ...
                    <!-- Session Info -->
                    <div
                        class="mt-6 inline-flex items-center bg-white bg-opacity-15 dark:bg-white dark:bg-opacity-25 backdrop-blur-sm rounded-full px-6 py-3 border border-white border-opacity-20 dark:border-opacity-30">
                        <div
                            class="w-8 h-8 bg-gradient-to-br from-blue-400 to-purple-600 dark:from-blue-500 dark:to-purple-700 rounded-full flex items-center justify-center mr-3">
                            <span
                ...
                <form method="POST" action="{{ route('password.confirm') }}" class="space-y-8" x-data="passwordConfirm()">
                    ...
                    <div class="space-y-3">
                        <label for="password" class="flex items-center text-sm font-bold text-gray-900 dark:text-white">
                            <svg class="w-5 h-5 mr-3 text-indigo-600 dark:text-indigo-400" fill="none"
                                stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M15 7a2 2 0 012 2m4 0a6 6 0 01-11.83 1M9 7a2 2 0 012-2m0 0a2 2 0 012-2 6 6 0 011.83 3M9 7h4m-4 0a2 2 0 00-2 2M9 7h4m-4 0v8a2 2 0 002 2h4a2 2 0 002-2M9 15v-4m4 4v-4">
                                </path>
                            </svg>
                            Current Password
                        ...
                        @if ($errors->has('password'))
                            <div
                                class="flex items-center space-x-2 text-red-700 dark:text-red-400 bg-red-50 dark:bg-red-900 border border-red-200 dark:border-red-700 rounded-lg p-3">
                        ...
                        <div
                            class="bg-blue-50 dark:bg-blue-900 border border-blue-200 dark:border-blue-700 rounded-lg p-3">
                    ...
                    <div class="space-y-4">
                        <button type="submit" :disabled="!password"
                            :class="(!password || isSubmitting) ? 'bg-gray-400 dark:bg-gray-600 cursor-not-allowed' :
                            'bg-gradient-to-r from-indigo-600 to-purple-700 dark:from-indigo-500 dark:to-purple-600 hover:from-indigo-700 hover:to-purple-800 dark:hover:from-indigo-600 dark:hover:to-purple-700 shadow-lg hover:shadow-xl transform hover:scale-105'"
    ...
    <script>
        ...
        function resetSessionTimer() {
            ...
            sessionTimer = setTimeout(() => {
                alert(
                'Your session will expire soon. Please complete the verification or return to the dashboard.');
