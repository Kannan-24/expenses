<x-app-layout>
    <x-slot name="title">
        {{ __('Edit Wallet') }} - {{ config('app.name', 'Cazhoo') }}
    </x-slot>
                    ...
                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                            ...
                            <nav class="flex text-sm" aria-label="Breadcrumb">
                                <ol class="inline-flex items-center space-x-1 md:space-x-2 flex-wrap">
                                    ...
                                    <li class="flex items-center">
                                        ...
                                        <span class="text-blue-100 font-medium">Edit Wallet</span>
                                    </li>
                                </ol>
                            </nav>
                        </div>
                        ...
                        <div class="flex items-center space-x-3">
                            <div class="text-center">
                                <p class="text-sm text-blue-200">Wallet ID</p>
                    ...
                    <div class="bg-gradient-to-br from-blue-50 to-blue-50 dark:from-blue-900 dark:to-blue-900 rounded-2xl border border-blue-200 dark:border-blue-700 p-6">
                        ...
                        <div class="space-y-3 text-sm">
                            <div class="flex items-start space-x-2">
                                ...
                                <p class="text-blue-800 dark:text-blue-200">Double-check the balance before updating</p>
                            </div>
                            <div class="flex items-start space-x-2">
                                <span class="text-blue-600 dark:text-blue-400 mt-0.5">•</span>
                                <p class="text-blue-800 dark:text-blue-200">Changing currency will affect all future transactions</p>
                            </div>
                            <div class="flex items-start space-x-2">
                                <span class="text-blue-600 dark:text-blue-400 mt-0.5">•</span>
                                <p class="text-blue-800 dark:text-blue-200">Inactive wallets won't appear in transaction forms</p>
                            </div>
                        </div>
                    </div>
