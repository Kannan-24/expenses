    ...
    <div class="min-h-scree">
        <div class="max-w-6xl mx-auto">
            ...
            <div class="bg-white dark:bg-gray-900 rounded-2xl shadow-xl border border-gray-200 dark:border-gray-700 mb-6 overflow-hidden">
                <div class="bg-gradient-to-r from-emerald-600 via-green-600 to-teal-700 dark:from-emerald-800 dark:via-green-800 dark:to-teal-900 p-4 sm:p-6">
                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                            ...
                            <nav class="flex text-sm" aria-label="Breadcrumb">
                                <ol class="inline-flex items-center space-x-1 md:space-x-2 flex-wrap">
                                    <li class="inline-flex items-center">
                                        <a href="{{ route('dashboard') }}" class="inline-flex items-center text-emerald-200 hover:text-white transition-colors">
                                    ...
                                    <li class="flex items-center">
                                        <svg class="w-4 h-4 mx-2 text-emerald-300" fill="currentColor" viewBox="0 0 20 20">
                                            <path d="M7.05 4.05a1 1 0 011.41 0l5.5 5.5a1 1 0 010 1.41l-5.5 5.5a1 1 0 01-1.41-1.41L12.09 10 7.05 4.95a1 1 0 010-1.41z" />
                                        </svg>
                                        <a href="{{ route('wallets.index') }}" class="text-emerald-200 hover:text-white transition-colors">
                                            Wallets
                                        </a>
                                    </li>
                                    <li class="flex items-center">
                                        ...
                                        <span class="text-emerald-100 font-medium">Create Wallet</span>
                                    </li>
                                </ol>
                            </nav>
                        </div>
                        ...
                        <div class="flex items-center space-x-4">
                            <div class="text-center">
                                <p class="text-sm text-emerald-200">Today</p>
                                <p class="text-lg font-bold text-white">Jul 07, 2025</p>
                            </div>
                            <div class="w-px h-12 bg-emerald-300 opacity-50"></div>
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        ...
                                        <div class="space-y-2">
                                            ...
                                            <select name="wallet_type_id" id="wallet_type_id" required x-model="selectedType"
                                                    class="w-full px-4 py-3 border-2 border-gray-300 dark:border-gray-600 rounded-xl focus:ring-4 focus:ring-purple-200 dark:focus:ring-purple-800 focus:border-purple-600 dark:focus:border-purple-400 transition-all duration-200 text-gray-900 dark:text-white bg-white dark:bg-gray-800 font-medium shadow-sm">
                                        ...
                                        <div class="space-y-2">
                                            ...
                                            <input type="number" 
                                                   ...
                                                   required
                                                   placeholder="0.00"
                                                   class="w-full px-4 py-3 border-2 border-gray-300 dark:border-gray-600 rounded-xl focus:ring-4 focus:ring-green-200 dark:focus:ring-green-800 focus:border-green-600 dark:focus:border-green-400 transition-all duration-200 text-gray-900 dark:text-white bg-white dark:bg-gray-800 font-medium shadow-sm placeholder-gray-500 dark:placeholder-gray-400">
                                            @error('balance')
                                                <p class="text-sm text-red-700 dark:text-red-400 flex items-center mt-2 font-semibold">
                                                    <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                                        ...
                                        <div class="space-y-2">
                                            ...
                                            <select name="currency_id" id="currency_id" required
                                                    class="w-full px-4 py-3 border-2 border-gray-300 dark:border-gray-600 rounded-xl focus:ring-4 focus:ring-indigo-200 dark:focus:ring-indigo-800 focus:border-indigo-600 dark:focus:border-indigo-400 transition-all duration-200 text-gray-900 dark:text-white bg-white dark:bg-gray-800 font-medium shadow-sm">
                                    ...
                                    <div class="flex flex-col sm:flex-row justify-between items-center pt-8 border-t border-gray-200 dark:border-gray-600 space-y-4 sm:space-y-0">
                                        ...
                                        <div class="flex flex-col sm:flex-row space-y-3 sm:space-y-0 sm:space-x-4 w-full sm:w-auto">
                                            ...
                                            <button type="submit" 
                                                    ...
                                                    :class="(isSubmitting || !walletName.trim()) ? 'bg-gray-400 dark:bg-gray-600 cursor-not-allowed' : 'bg-gradient-to-r from-emerald-600 to-green-700 hover:from-emerald-700 hover:to-green-800 shadow-lg hover:shadow-xl transform hover:scale-105'"
                ...
                <div class="lg:col-span-1 space-y-6">
                    ...
                    <div class="bg-gradient-to-br from-emerald-50 to-green-50 dark:from-emerald-900 dark:to-green-900 rounded-2xl border border-emerald-200 dark:border-emerald-700 p-6">
                        ...
                        <div class="space-y-3 text-sm">
                            <div class="flex items-start space-x-2">
                                ...
                                <p class="text-emerald-800 dark:text-emerald-200">Choose descriptive names for easy identification</p>
                            </div>
                            <div class="flex items-start space-x-2">
                                <span class="text-emerald-600 dark:text-emerald-400 mt-0.5">•</span>
                                <p class="text-emerald-800 dark:text-emerald-200">Set the correct initial balance for accurate tracking</p>
                            </div>
                            <div class="flex items-start space-x-2">
                                <span class="text-emerald-600 dark:text-emerald-400 mt-0.5">•</span>
                                <p class="text-emerald-800 dark:text-emerald-200">Select the appropriate currency for each wallet</p>
                            </div>
                            <div class="flex items-start space-x-2">
                                <span class="text-emerald-600 dark:text-emerald-400 mt-0.5">•</span>
                                <p class="text-emerald-800 dark:text-emerald-200">Active wallets appear in transaction forms</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white dark:bg-gray-900 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 p-6">
                        ...
                        <div class="space-y-2 text-sm">
                            <div class="p-2 bg-green-50 dark:bg-green-900 rounded text-green-800 dark:text-green-200">
                                Bank Account - For checking/savings accounts
                            </div>
                            <div class="p-2 bg-blue-50 dark:bg-blue-900 rounded text-blue-800 dark:text-blue-200">
                                Credit Card - For credit card accounts
                            </div>
                            <div class="p-2 bg-yellow-50 dark:bg-yellow-900 rounded text-yellow-800 dark:text-yellow-200">
                                Cash - For physical cash wallets
                            </div>
                            <div class="p-2 bg-purple-50 dark:bg-purple-900 rounded text-purple-800 dark:text-purple-200">
                                Digital - For online/mobile wallets
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white dark:bg-gray-900 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 p-6">
                        ...
                        <div class="space-y-3 text-sm">
                            ...
                            <div class="flex justify-between">
                                ...
                                <span class="font-medium text-gray-900 dark:text-white">13:13 UTC</span>
                            </div>
                            <div class="flex justify-between">
                                <span class="text-gray-600 dark:text-gray-400">Action:</span>
                                <span class="font-medium text-gray-900 dark:text-white">Creating Wallet</span>
                            </div>
                        </div>
                    </div>
