<x-app-layout>
    <x-slot name="title">
        {{ __('Reports & Analytics') }} - {{ config('app.name', 'Cazhoo') }}
    </x-slot>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            @if (auth()->user()->hasRole('user'))
                ...
                <div
                    ...
                    <!-- Card Content -->
                    <form action="{{ route('reports.generate') }}" method="GET" class="p-6 space-y-6 report-form"
                        x-data="reportForm()">
                        @csrf
                        ...
                        <button type="submit"
                            ...
                            <span class="relative flex items-center justify-center button-content">
    ...
    <script>
        ...
        // Reset all loading states on page load
        function resetLoadingStates() {
            ...
            document.querySelectorAll('.submit-button').forEach(button => {
                ...
                if (buttonContent) {
                    ...
                    if (button.closest('form').querySelector('input[name="report_type"][value="transactions"]')) {
                        buttonContent.innerHTML = `
                            ...
                            Generate Transaction Report
                        `;
                    } else if (button.closest('form').querySelector('input[name="report_type"][value="budgets"]')) {
                        buttonContent.innerHTML = `
                            <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M9 17v-2m3 2v-4m3 4v-6m2 10H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z">
                            ...
                            Generate Budget Report
                        `;
                    } else if (button.closest('form').querySelector('input[name="report_type"][value="tickets"]')) {
                        buttonContent.innerHTML = `
                            <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M9 17v-2m3 2v-4m3 4v-6m2 10H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z">
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            forms.forEach(form => {
                ...
                form.addEventListener('submit', function(e) {
                    ...
                    // Set a timeout to reset states if something goes wrong
                    setTimeout(() => {
                        resetLoadingStates();
        ...
        // Reset states when user navigates back
        ...
        // Reset states when page becomes visible (tab switching)
        ...
        function showLoadingOverlay() {
            ...
            overlay.innerHTML = `
                <div class="bg-white dark:bg-gray-800 rounded-2xl p-8 flex flex-col items-center space-y-4 max-w-sm mx-4 shadow-2xl">
                    ...
                    <div class="text-center">
                        ...
                        <p class="text-gray-600 dark:text-gray-400">Please wait while we prepare your report...</p>
                    </div>
                </div>
            `;
