<x-app-layout>
    ...
    <div class="sm:ml-64">
        <div class="w-full h-auto mx-auto max-w-7xl sm:px-6 lg:px-8 bg-white p-4 rounded-2xl shadow m-4 flex flex-col justify-between">
                    ...
                    <div x-data="{ showModal: false }" class="absolute right-1.5 top-1.3">
                        ...
                        <div x-show="showModal" x-cloak
                            ...
                            <div class="bg-white rounded-lg shadow-lg w-full max-w-md p-6"
                                ...
                                <form method="GET" id="expense-filter-form-modal" class="space-y-4">
                                    <!-- Quick Filter -->
                                    <div>
                    ...
                    <tbody>
                        @forelse($expenses as $exp)
                            <tr class="border-b border-gray-200 hover:bg-gray-50">
                                ...
                                <td class="px-4 py-2">
                                    <span class="{{ $exp->type === 'income' ? 'text-green-600' : 'text-red-600' }}">
