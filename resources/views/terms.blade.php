...
<body class="bg-white text-gray-800 font-sans">
    ...
    <div class="sm:ml-64">
        <div class="w-full mx-auto max-w-4xl sm:px-6 lg:px-8 bg-white p-6 rounded-2xl shadow m-4">
            ...
            <h2 class="text-2xl font-semibold mt-6 mb-2">1. Eligibility</h2>
            <p class="mb-4 text-gray-700">
            ...
            <h2 class="text-2xl font-semibold mt-6 mb-2">3. Use of Services</h2>
            <p class="mb-4 text-gray-700">
            ...
            <h2 class="text-2xl font-semibold mt-6 mb-2">4. Payment and Subscriptions</h2>
            <p class="mb-4 text-gray-700">
            ...
            <h2 class="text-2xl font-semibold mt-6 mb-2">5. Intellectual Property</h2>
            <p class="mb-4 text-gray-700">
            ...
            <h2 class="text-2xl font-semibold mt-6 mb-2">6. Termination</h2>
            <p class="mb-4 text-gray-700">
            ...
            <h2 class="text-2xl font-semibold mt-6 mb-2">7. Disclaimer of Warranties</h2>
            <p class="mb-4 text-gray-700">
            ...
            <h2 class="text-2xl font-semibold mt-6 mb-2">8. Limitation of Liability</h2>
            <p class="mb-4 text-gray-700">
            ...
            <h2 class="text-2xl font-semibold mt-6 mb-2">9. Privacy Policy</h2>
            <p class="mb-4 text-gray-700">
            ...
            <h2 class="text-2xl font-semibold mt-6 mb-2">10. Changes to the Terms</h2>
            <p class="mb-4 text-gray-700">
            ...
            <h2 class="text-2xl font-semibold mt-6 mb-2">12. Contact Us</h2>
            <p class="mb-4 text-gray-700">
