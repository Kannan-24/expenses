                ...
                <form method="GET" class="space-y-4" id="filter-form">
                    ...
                    <div class="flex flex-wrap items-center justify-center gap-3">
                        ...
                        <div class="flex flex-wrap gap-2">
                            <button type="button"
                                @click="document.querySelector('select[name=filter]').value='7days'; document.querySelector('#filter-form').submit();"
                            ...
                            <button type="button"
                                @click="document.querySelector('select[name=filter]').value='1month'; document.querySelector('#filter-form').submit();"
                            ...
                            <button type="button"
                                @click="document.querySelector('select[name=type]').value='income'; document.querySelector('#filter-form').submit();"
                            ...
                            <button type="button"
                                @click="document.querySelector('select[name=type]').value='expense'; document.querySelector('#filter-form').submit();"
                    ...
                    <div x-show="showAdvanced" x-transition
                        class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-4 pt-4 border-t border-gray-200 dark:border-gray-600">
                        <!-- Quick Filter Hidden Select -->
                        <select name="filter" class="hidden">
                            <option value="">All</option>
                            <option value="7days" {{ request('filter') == '7days' ? 'selected' : '' }}>Last 7 Days
                            </option>
                                ...
                                <tr>
                                    <td colspan="8" class="px-6 py-12 text-center">
                                        <div class="flex flex-col items-center">
                                            ...
                                            <p class="text-gray-500 dark:text-gray-400 mb-4">Get started by creating
