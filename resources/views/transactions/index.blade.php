            ...
            <div class="flex justify-between items-center mb-3">
                ...
                <a href="{{ route('transactions.create') }}"
                    class="inline-flex items-center px-4 py-2 bg-blue-600 text-white text-sm font-medium rounded hover:bg-blue-700 shadow
                        ...
                        px-2 py-2 text-base font-bold sm:font-medium"
                >
                    <svg class="w-5 h-5 sm:w-4 sm:h-4 mr-0 sm:mr-1 sm:mr-1 mr-0" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
