<x-app-layout>
    <x-slot name="title">
        {{ __('User Details') }} - {{ config('app.name', 'Cazhoo') }}
    </x-slot>
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                <div class="space-y-4">
                                    <div class="flex flex-col">
                                        <label class="text-sm font-semibold text-gray-500 uppercase tracking-wide">Full
                                            Name</label>
                                        <span class="mt-1 text-lg font-medium text-gray-900">{{ $user->name }}</span>
                                    </div>
                                    <div class="flex flex-col">
                                        <label class="text-sm font-semibold text-gray-500 uppercase tracking-wide">Email
                                            Address</label>
                                ...
                                <div class="space-y-4">
                                    <div class="flex flex-col">
                                        <label class="text-sm font-semibold text-gray-500 uppercase tracking-wide">Phone
                                            Number</label>
                                    ...
                                    <div class="flex flex-col">
                                        <label
                                            class="text-sm font-semibold text-gray-500 uppercase tracking-wide">Address</label>
                                        <span class="mt-1 text-lg text-gray-900">
                            ...
                            <div class="mt-6 pt-6 border-t border-gray-200">
                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                    ...
                                    <div class="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
                                        ...
                                        <span
                                            class="text-sm font-bold text-gray-900">{{ $user->created_at->format('M d, Y') }}</span>
                                    </div>
                                    <div class="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
                                    ...
                                    <div class="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
                                        ...
                                        <span
                                            class="text-sm font-bold text-gray-900">{{ $user->updated_at->format('M d, Y') }}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="p-6">
                            <div class="space-y-4">
                                ...
                                <div
                                    ...
                                    <span
                                        class="text-2xl font-bold text-blue-600">{{ number_format($user->transactions->count()) }}</span>
                                </div>

                                <!-- Categories -->
                                <div
                                    class="flex items-center justify-between p-4 bg-purple-50 rounded-lg border border-purple-100">
                                    <div class="flex items-center">
                                        <div
                                    ...
                                    <span
                                        class="text-2xl font-bold text-purple-600">{{ number_format($user->categories->count()) }}</span>
                                </div>
                                ...
                                <div
                                    ...
                                    <span
                                        class="text-2xl font-bold text-orange-600">{{ number_format($user->budgets->count()) }}</span>
                                </div>
                                ...
                                <div
                                    ...
                                    <span
                                        class="text-2xl font-bold text-green-600">{{ number_format($user->wallets->count()) }}</span>
                                </div>
                            </div>
                            ...
                            <div class="mt-6 pt-6 border-t border-gray-200">
                                ...
                                <div class="space-y-2">
                                    <a href="#"
                                        class="block w-full px-4 py-2 text-sm text-center text-gray-700 bg-gray-100 rounded-lg hover:bg-gray-200 transition-colors duration-200">
                                        View Transactions
                                    </a>
                                    <a href="#"
                                        class="block w-full px-4 py-2 text-sm text-center text-gray-700 bg-gray-100 rounded-lg hover:bg-gray-200 transition-colors duration-200">
                    ...
                    <div class="p-6">
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            <div class="text-center p-4 bg-gray-50 rounded-lg">
                                <div
                                    class="w-12 h-12 mx-auto bg-indigo-100 rounded-full flex items-center justify-center mb-3">
                            ...
                            <div class="text-center p-4 bg-gray-50 rounded-lg">
                                ...
                                <p class="text-2xl font-bold text-gray-700 mt-1">
                                    {{ $user->created_at->diffForHumans(now(), [
                                        'parts' => 3, // limits to 3 parts: days, hours, minutes
                                        'join' => ', ',
                                        'syntax' => Carbon\CarbonInterface::DIFF_ABSOLUTE, // prevents "ago" or "from now"
                                    ]) }}
                                </p>
                            </div>
                            ...
                            <div class="text-center p-4 bg-gray-50 rounded-lg">
                                <div
                                    class="w-12 h-12 mx-auto bg-purple-100 rounded-full flex items-center justify-center mb-3">
                                    <svg class="w-6 h-6 text-purple-600" fill="currentColor" viewBox="0 0 20 20">
                                        <path d="M9 2a1 1 0 000 2h2a1 1 0 100-2H9z"></path>
                                        <path fill-rule="evenodd"
                                            d="M4 5a2 2 0 012-2v1a1 1 0 001 1h6a1 1 0 001-1V3a2 2 0 012 2v6a2 2 0 01-2 2H6a2 2 0 01-2-2V5zm3 3a1 1 0 000 2h.01a1 1 0 100-2H7zm3 0a1 1 0 000 2h3a1 1 0 100-2h-3zm-3 4a1 1 0 100 2h.01a1 1 0 100-2H7zm3 0a1 1 0 100 2h3a1 1 0 100-2h-3z"
                                            clip-rule="evenodd"></path>
                                    </svg>
                                </div>
