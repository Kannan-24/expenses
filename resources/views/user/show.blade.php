        ...
        <div class="w-full mx-auto max-w-7xl sm:px-6 lg:px-8 bg-white p-6 rounded-2xl shadow m-4 flex flex-col"
                ...
                <nav class="flex text-sm text-gray-500" aria-label="Breadcrumb">
                    <ol class="inline-flex items-center space-x-1 md:space-x-3">
                        ...
                        <li class="flex items-center">
                            <a href="{{ route('user.index') }}" class="inline-flex items-center hover:text-blue-600">
            ...
            <div class="flex flex-col gap-4">
                ...
                <div class="grid grid-cols-1 gap-4">
                    ...
                    <div class="flex items-center gap-4">
                        <span class="w-16 text-sm font-bold text-gray-900">Email</span>
                        <span class="mx-1">:</span>
                        <span class="text-base text-gray-600">{{ $user->email }}</span>
                    </div>
                    <div class="flex items-center gap-4">
                        <span class="w-16 text-sm font-bold text-gray-900">Phone</span>
                        <span class="mx-1">:</span>
                        <span class="text-base text-gray-600">{{ $user->phone ?? 'N/A' }}</span>
                    </div>
                    <div class="flex items-center gap-4">
                        <span class="w-16 text-sm font-bold text-gray-900">Address</span>
                        <span class="mx-1">:</span>
                        <span class="text-base text-gray-600">{{ $user->address ?? 'N/A' }}</span>
                    </div>
                </div>
